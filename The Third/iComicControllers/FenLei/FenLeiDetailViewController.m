...
@interface FenLeiDetailViewController ()<UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
-(void)sendRequestWithURL{
    ...
    _dataArray = [[NSMutableArray alloc]initWithCapacity:0];
     NSString * newUrl = [NSString stringWithFormat:@"http://222.231.4.196:9090/manhuakong/ComicHandle.ashx?cid=20160320&ckey=6710dbw5d09ab935ae9037cd89c4bb1a&method=booklist&pageSize=24&cataID=%d&state=0&order=0&pageIndex=0",self.icId];
  
    [ICFunction getHttpURL:self andWithUrl:newUrl andWithType:@"text/plain" completation:^(id object) {
        if ([object isKindOfClass:[NSDictionary class]]) {
            NSArray * icArray =object[@"Booklist"];
