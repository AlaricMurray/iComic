...
- (void)commonInit{
    ...
    backgroudView_ = [[UIImageView alloc] initWithFrame:[UIScreen mainScreen].bounds];
    ...
    trackView_ = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height-kTrackViewHeight-1, [UIScreen mainScreen].bounds.size.width, kTrackViewHeight)];
